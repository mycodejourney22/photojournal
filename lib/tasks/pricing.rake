...
namespace :pricing do
    ...
    task :seed => :environment do
      ...
      pricing_data = [
        ...
        {
            name: "Family",
            description: "This shoot accommodates up to a 5-person family. For larger families, please contact the studio directly to book. Studio props are available, but additional props must be brought in.",
            amount: 45000,
            discount: 0.0,
            duration: 45,
            included: "5",
          ...
          {
            name: "Family",
            description: "This session accommodates up to 5 people, with the option for family or siblings to join during one outfit change. Studio props are available, but you’ll need to bring any additional props.",
            amount: 75000,
            discount: 0.0,
            duration: 60,
            included: "8",
          ...
          {
            name: "Newborn",
            description: "We provide baby wraps, furs, and studio props. If you need additional or different items, please bring them with you.",
            amount: 60000,
            discount: 0.0,
            duration: 45,
            included: "5",
          ...
          {
              name: "Maternity",
              description: "This session is designed for one person, with the option for partner or siblings to join during one outfit change. Studio props are available, but you’ll need to bring any additional props.",
              amount: 75000,
              discount: 0.0,
              duration: 60,
              included: "8",    
        ...
        {
            name: "Pre Wedding",
            description: "This session is designed for two people. Studio props are available, but you’ll need to bring any additional props.",
            amount: 45000,
            discount: 0.0,
            duration: 45,
            included: "5",
