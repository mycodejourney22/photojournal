...
Price.create!([
  ...
  # { name: "Passport Photos", outfit: "1 Outfit", description: "This shoot is designed for one person.",
  ...
  { name: "Graduation", outfit: "1 Outfit", description: "This shoot is designed for one person.",
