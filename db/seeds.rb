...
Price.create!([
  ...
  { name: "Christmas Kiddies", outfit: "1 Outfit", description: "This shoot is designed for one person. Studio props are available, but you’ll need to bring any additional props.",
    ...
    { name: "Christmas Family", outfit: "4 Outfit", description: "This shoot accommodates up to a 5-person family. For larger families, please contact the studio directly to book. Studio props are available, but additional props must be brought in.",
    ...
    { name: "Christmas Family", outfit: "5 Outfit", description: "This shoot accommodates up to a 5-person family. For larger families, please contact the studio directly to book. Studio props are available, but additional props must be brought in.",
